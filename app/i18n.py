...
_S: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "date_out_of_bounds_error": "❌ 無効な日付です。\n実在する日付を選択してください（1920-01-01以降、今日以前）。",
    ...
    "en": {
        ...
        "date_out_of_bounds_error": "❌ Invalid date.\nPlease select a valid date (between 1920-01-01 and today).",
